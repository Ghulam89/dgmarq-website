  ...
  return (
    <div className="flex gap-1 relative items-center">
      {userInfo ? (
        ...
        <>
          <div onClick={toggleDropdown} className="flex text-white relative bg-slate-800 rounded-full w-10 h-10 sm:w-12 sm:h-12 cursor-pointer items-center justify-center">
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20.417 23H3v-2.58c0-1.4.79-2.68 2.047-3.292 1.468-.715 3.707-1.461 6.661-1.461 2.955 0 5.194.746 6.662 1.46a3.655 3.655 0 012.047 3.293V23zM16.75 6.042c0 2.784-2.257 5.958-5.042 5.958-2.784 0-5.041-3.174-5.041-5.958a5.041 5.041 0 1110.083 0z" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          {isOpen && (
          ...
          <div onClick={toggleDropdown} className="hidden sm:block cursor-pointer">
            <div className="flex flex-col items-center">
