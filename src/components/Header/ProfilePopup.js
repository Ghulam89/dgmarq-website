  ...
  const handleClick = () => {
    signInWithPopup(auth, provider).then(async (data) => {
      ...
      try {
        ...
        const response = await axios.post(`${Base_url}/user/register`, parmas);
    ...
    <div className=" flex gap-1 relative items-center">
      {userInfo ? (
        <div className=" flex items-center gap-2">
          <div
            onClick={openProfileFun}
            className=" w-12 cursor-pointer h-12 rounded-full overflow-hidden"
          >
            {userInfo?.logo ? (
              <img
                src={userInfo?.logo}
          ...
          <div onClick={openProfileFun} className=" relative sm:block hidden">
            <div className="  flex flex-col items-center">
              ...
              <span className=" text-white text-[11px]   whitespace-nowrap font-medium">
                Your Dgmarq
              </span>
            </div>
            ...
            {userInfo?.logo ? (
              ...
              />
                ...
                <div className="mt-3 border-t border-b pb-2 pt-3 space-y-4">
                  <Link
                    to={"/dashboard"}
                    className="flex items-center text-sm gap-2 text-gray-700 hover:text-blue-600 cursor-pointer"
                  >
                ...
                <div className=" pt-2 flex  justify-between items-center">
                  ...
                  <div
                    onClick={() => removeFun()}
                    className=" flex cursor-pointer text-sm items-center gap-2"
                  >
                    Sign out{" "}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          {isOpen && (
            <div className="absolute right-0  text-center mt-2 top-12 w-80 bg-white shadow-lg rounded-md p-5 z-50">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => handleClick()}
                  className="w-full flex items-center  text-sm pr-7 font-semibold justify-between gap-2 p-3  border-blue border rounded-sm  text-blue  hover:text-white   hover:bg-secondary"
                >
                  <FaGoogle size={20} />
                  Sign in With Google
                </button>
              ...
              <p className="text-xs text-gray-500 text-center mt-3">
                By clicking Sign in with Google, Facebook, or PayPal, you agree
                to G2A's Terms & Conditions and Privacy Policy.
              </p>
              ...
              <div className="mt-5 border-t pt-3 space-y-3">
                <Link
                  to="/register"
                  className="flex items-center text-sm gap-2 text-gray-700 hover:text-blue cursor-pointer"
                >
                  {/* <IoPersonOutline size={20} /> */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
