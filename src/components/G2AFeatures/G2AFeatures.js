...
const G2AFeatures = () => {
  return (
    <div className="bg-black text-white py-8 px-4 flex justify-center">
      <div className="flex  sm:flex-row flex-col items-center space-x-6 max-w-screen-lg">
        {/* QR Code */}
        ...
        <div className="flex sm:flex-row  flex-col items-center space-y-6 ">
          ...
          <div className="flex items-start pt-4 space-x-4">
            ...
            <div>
              <h3 className="font-bold">Unlock even better deals with the</h3>
              <p className="text-gray-400">Download now and browse the enhanced offer</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-bold">Save more with G2A Plus</h3>
              <p className="text-gray-400">Discover all the special benefits</p>
            </div>
          </div>
        </div>
      </div>
