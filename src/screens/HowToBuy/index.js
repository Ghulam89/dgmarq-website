     ...
     <div
        ...
        <div className=' flex'>
            ...
            <ul className=' flex items-center gap-2'>
                ...
                <h2 className=' pt-4 text-4xl font-semibold'>How can I buy a digital item on G2A.COM?
                </h2>
...
<div className=' py-2'>
    ...
    <h2 className=' text-blue-950 text-2xl font-semibold'>How do I search for digital items on G2A.COM?
...
<h2 className=' text-blue-950 text-2xl pt-3 font-semibold'>I found what I want to buy, what do I do now?
...
<div className=' py-4'>
    <div className=' px-4 border bg-gray-100 py-8 flex justify-between items-center'>
        <h2 className=' font-semibold text-2xl'>Was this helpfull?</h2>
