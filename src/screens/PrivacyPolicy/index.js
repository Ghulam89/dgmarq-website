...
<p className=' pt-2 text-black'>Contact us

</p>


<p className=' pt-2 text-black'>By Post: DPO, DGMARQ.COM Limited 31/F, Tower Two, Times Square,1 Matheson Street, Causeway Bay, Hong Kong
...
<h3 className="text-2xl font-semibold mb-6 pt-2">10. Representative in European Union
...
<p className=' pt-2 text-black'>Appendix no 1
...
<p className=' pt-2 text-black'>LIST OF DGMARQ.COM LIMITED BUSINESS PARTNERS AND/OR AFFILIATES
...
<p className=' pt-2 font-semibold text-black'>APPENDIX NO 1 TO PRIVACY POLICY
...
<p className=' pt-2 font-semibold text-black'>LIST OF DGMARQ.COM BUSINESS PARTNERS AND/OR AFFILIATES
